...
LONG1:=IF(LONG1=NIL, 10 ,LONG1)
   ...
   CASE LONG1=61  //ENE-92
      FDIA2=RTRIM(MESNOM(FDIA1,3))
      FDIA2=FDIA2+"-"
...
FUNCTION DIAFINMES(FDIA1)
   FDIA2:=FDIA1-DAY(FDIA1)+LASTDAYOM(FDIA1)
RETURN(FDIA2)

FUNCTION DIAINIMES(FDIA1)
   FDIA2:=FDIA1-DAY(FDIA1)+1
RETURN(FDIA2)


FUNCTION DIAMESMAS(FDIA1,FMES1)
	FDIA2:=ADDMONTH(FDIA1,FMES1)
/*
   FMES1:=IF(FMES1=NIL,1,FMES1)
   FDIA2:=FDIA1
   FOR N=1 TO FMES1
...
***PASAR DE 2008-12-31 A 31-12-2008
FUNCTION DIACAMBIARFTO(FDIA1)
   FDIA1:=STRTRAN(FDIA1,"-","")
   FDIA1:=STRTRAN(FDIA1,"/","")
   FDIA1:=STRTRAN(FDIA1,".","")
   FDIA2:=SUBSTR(FDIA1,7,2)+"-"+SUBSTR(FDIA1,5,2)+"-"+LEFT(FDIA1,4)
RETURN(FDIA2)
